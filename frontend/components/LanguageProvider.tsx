...
const STATUS_LABELS:Record<string,[string,string]>={
  ...
  needs_information:['تحتاج معلومات','Needs information'],
  ready_for_analysis:['جاهزة للتحليل','Ready for analysis'],
  ...
  deferred:['مؤجلة','Deferred'],
  reopened:['أعيد فتحها','Reopened'],
  not_started:['لم تبدأ','Not started'],
  in_progress:['قيد التنفيذ','In progress'],
  blocked:['متعثرة','Blocked'],
